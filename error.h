...
#define ERR_BAD_BIT_LENGTH					-42 /**< Do dai bit thuat toan khong hop le (chi ho tro RSA 2048, 3072, 4096)*/
#define	ERR_GENERATE_KEY					-43 /**< Khong sinh duoc khoa*/
#define ERR_WRITE_USER_PRIVKEY				-44 /**< Khong luu duoc khoa bi mat*/
#define	ERR_WRITE_USER_PUBKEY				-45 /**< Khong luu duoc khoa cong khai*/
