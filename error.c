...
static struct enum_specs error_list[] =
{
	...
	{ ERR_BAD_BIT_LENGTH				, "Do dai bit thuat toan khong hop le (chi ho tro RSA 2048, 3072, 4096)"},
	{ ERR_GENERATE_KEY					, "Khong sinh duoc khoa"},
	{ ERR_WRITE_USER_PRIVKEY			, "Khong luu duoc khoa bi mat"},
	{ ERR_WRITE_USER_PUBKEY				, "Khong luu duoc khoa cong khai"}
};
